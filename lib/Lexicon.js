      ...
      value: function() {
        ...
        this.forEach(function(entry) {
          ...
          for (field in entryvalue.igt) {
            if (entryvalue.igt.hasOwnProperty(field)) {
              ...
              try {
                ...
                binding = bind(fieldElement, "innerText", {
                  "<->": "igt." + field,
                  "source": entryvalue
                });
                bindings.push(binding);
          ...
          binding = bind(headword, "innerHTML", {
            "<->": "igt.morphemes? igt.morphemes: igt.gloss",
            "source": entryvalue
          });
          ...
          binding = bind(discussion, "innerHTML", {
            "<->": "igt.discussion",
            "source": entryvalue
          });
          bindings.push(binding);
          ...
          binding = bind(contexts, "innerHTML", {
            "<-": "' '+utteranceContext.join(',')+utteranceContext?utteranceContext.length : '0'",
            "source": entryvalue
          });
          bindings.push(binding);
          binding = bind(listItem, "title", {
            "<-": "'Example: '+utteranceContext.join(' Example: ')",
            "source": entryvalue
          });
          bindings.push(binding);
