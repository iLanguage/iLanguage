...
(function(exports) {
  ...
  /*
    Enabling Binding for contenteditable span
   */
  try {
    var changeInnerHTML = function(event) {
      ...
      console.log("keyup changeInnerHTML", event.target, event.target.value, event.target.innerText);
      console.log("innerHTML", event.target.innerHTML);
    };

    var HTMLSpanElement = Object.getPrototypeOf(document.createElement("span"));
    HTMLSpanElement.makePropertyObservable = function(key) {
      if (this.contentEditable) {
        console.log("keyup makePropertyObservable", this, this.value, this.innerText, this.innerHTML);
        this.innerText = this.innerText ? this.innerText : this.value;
        this.addEventListener("keyup", changeInnerHTML);
      }
    };
    HTMLSpanElement.makePropertyUnobservable = function(key) {
      if (this.contentEditable) {
        this.removeEventListener("keyup", changeInnerHTML);
      }
    };
  } catch (e) {
    console.log("Not making contenteditable bindable ", e);
  }
