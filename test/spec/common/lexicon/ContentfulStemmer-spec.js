...
describe('Language Independant', function() {
  ...
  it('should accept a (test English 1) text', function() {
    ...
    expect(result.nonContentWordsArray)
      .toEqual(['1', '2', '3', '4', '42', '5', '6', '7', 'a', 'album', 'also', 'an', 'and', 'as', 'band', 'be', 'by', 'cloud', 'comic', 'ep', 'film', 'from', 'fu', 'game', 'group', 'in', 'indie', 'is', 'mass', 'music', 'of', 'on', 'open', 'or', 'other', 'pc', 'play', 'rock', 'see', 'song', 'st', 'that', 'the', 'to', 'uk', 'used', 'uses', 'wan', 'white', 'will', 'zach']);
    expect(result.buzzWordsArray)
      .toEqual(['clouds', 'disambiguation', 'technology', 'character', 'british', 'science', 'fiction', 'system', 'describe', 'literature', 'storage', 'source', 'software', 'interstellar', 'between', 'electron', 'experimental', 'computing', 'information', 'computer', 'writer', 'operating', 'sobiech']);
  });
  ...
  it('should accept a (test English 2) text', function() {
    ...
    var result = LexemeFrequency.calculateNonContentWords(textToTest);
    expect(result.nonContentWordsArray)
      .toEqual(['15', '1950s', 'a', 'also', 'an', 'and', 'are', 'as', 'at', 'be', 'by', 'can', 'cloud', 'data', 'do', 'for', 'go', 'in', 'is', 'it', 'like', 'more', 'no', 'of', 'on', 'or', 'over', 'run', 'such', 'term', 'that', 'the', 'this', 'time', 'to', 'up', 'use', 'used', 'users', 'which', 'with']);
    expect(result.buzzWordsArray)
      .toEqual(['computing', 'service', 'services', 'resources', 'computers', 'software', 'server', 'shared', 'application', 'infrastructure', 'hardware', 'sharing', 'business', 'multiple', 'client', 'remote', 'location', 'utility', 'hosted', 'computer', 'through', 'mainframe', 'terminals', 'founded']);
  });
  ...
  it('should accept a (test French) text', function() {
    ...
    var result = LexemeFrequency.calculateNonContentWords(textToTest);
    expect(result.nonContentWordsArray)
      .toEqual(['0', '1', '10', '11', '12', '2', '3', '4', '40', '5', '6', '7', '8', '9', 'a', 'au', 'b', 'c', 'ce', 'comme', 'd1', 'd2', 'dans', 'de', 'des', 'du', 'dû', 'd’eau', 'en', 'est', 'et', 'eu', 'glace', 'i', 'ii', 'il', 'la', 'le', 'les', 'leur', 'mais', 'ne', 'nuage', 'on', 'ou', 'où', 'par', 'plus', 'pour', 'que', 'qui', 'sa', 'se', 'selon', 'si', 'un', 'une', 'y', '«', '°c', '»', 'à']);
    expect(result.buzzWordsArray)
      .toEqual(['nuages', 'formation', 'vapeur', 'produit', 'condensation', 'classification', 'gouttelettes', 'famille', 'siècle', 'refroidissement', 'particules', 'liquide']);
  });
  ...
  it('should accept a text and a weight', function() {
    ...
    var result = LexemeFrequency.calculateNonContentWords(textToTest);
    expect(result.nonContentWordsArray)
      .toEqual(['1', '1797', '1960s', '1969', '1977', '1980s', '1990s', '1992', '1997', '2', '2000', '2005', '3', '4', '42', '5', '6', '60s', '7', 'a', 'after', 'album', 'also', 'an', 'and', 'arntz', 'as', 'b boy', 'band', 'based', 'be', 'book', 'bou', 'by', 'cake', 'chaka', 'cloud', 'comic', 'cut', 'dense', 'don', 'dwarf', 'early', 'ep', 'film', 'final', 'fire', 'frayn', 'from', 'fu', 'fung', 'game', 'gos', 'group', 'hide', 'hong', 'in', 'indie', 'is', 'joni', 'keng', 'khan', 'king', 'kings', 'known', 'kong', 'kung', 'late', 'lee', 'level', 'mass', 'may', 'media', 'milky', 'model', 'music', 'near', 'nine', 'of', 'on', 'open', 'or', 'other', 'our', 'paris', 'pc', 'play', 'point', 'pop', 'rays', 'red', 'refer', 'rise', 'rock', 'saint', 'see', 'set', 'sites', 'son', 'song', 'sound', 'st', 'stars', 'tag', 'tags', 'text', 'than', 'that', 'the', 'this', 'to', 'uk', 'use', 'used', 'uses', 'video', 'vii', 'wan', 'way', 'web', 'white', 'will', 'zach']);
    expect(result.buzzWordsArray)
      .toEqual(['clouds', 'disambiguation', 'technology', 'character', 'british', 'science', 'fiction', 'system', 'describe', 'literature', 'storage', 'source', 'software', 'interstellar', 'between', 'electron', 'experimental', 'computing', 'information', 'computer', 'writer', 'operating', 'sobiech', 'studies', 'browser based', 'suspended', 'instantly', 'usable', 'turning', 'makers', 'visual', 'depiction', 'user generated', 'atmosphere', 'typically', 'cloud s', 'content', 'networked', 'online', 'cloud com', 'company', 'develops', 'orchestration', 'cloudstack', 'contents', 'magellanic', 'irregular', 'galaxies', 'galaxy', 'region', 'molecular', 'containing', 'molecules', 'analogy', 'orbits', 'around', 'nucleus', 'mathematics', 'vertices', 'three dimensional', 'coordinate', 'facility', 'investigate', 'microphysics', 'galactic', 'cosmic', 'chamber', 'device', 'particle', 'physics', 'strife', 'fantasy', 'visible', 'comics', 'marvel', 'cloudbase', 'fictional', 'skyborne', 'headquarters', 'spectrum', 'television', 'series', 'captain', 'scarlet', 'mysterons', 'written', 'directed', 'thompson', 'produced', 'comedy', 'aristophanes', 'philosophical', 'comedic', 'internet based', 'playwright', 'michael', 'development', 'richard', 'cumberland', 'unknowing', 'medieval', 'mystical', 'condensed', 'scottish', 'droplets', 'operated', 'australian', 'stored', 'sydney', 'australia', 'consisting', 'statistical', 'microsounds', 'naughty', 'servers', 'retroglide', 'spires', 'sunset', 'rather', 'mitchell', 'ranaldo', 'tiamat', 'client', 'nosound', 'cloudy', 'average', 'computers', 'dancer', 'director', 'florida', 'surname', 'california', 'former', 'settlement', 'county', 'clodoald', '522–560', 'better', 'chlodomer', 'orleans', 'saint cloud', 'commune', 'western', 'suburbs', 'france', 'frozen', 'third person', 'puzzle', 'crystals', 'mccloud']);
  });
