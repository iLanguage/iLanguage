...
describe(
  "Corpus: as a user I want to be able to import via drag and drop",
  function() {
...
describe(
  "Corpus: as a user I want to be able to go offline, but still have the most recent objects in my corpus available",
  function() {
