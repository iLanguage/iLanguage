...
describe("text generator", function() {
  ...
  describe("seperators", function() {
    ...
    it("should generate morphologically segmented texts", function() {
      var smallUnicodeText = randomMorphologicalText(13);
      expect(smallUnicodeText).toBeDefined();
      console.log(smallUnicodeText);
      expect(smallUnicodeText.split(" ").length).toEqual(13);
  ...
  describe("performance", function() {
    ...
    it("should throw an error if generating a text larger than 100000 words", function() {
      try {
        ...
        expect(" a sucessful result ").toContain("Maximum call stack size exceeded");
      } catch (exception) {
        expect(exception.message).toContain("Maximum call stack size exceeded");
      }
    });
